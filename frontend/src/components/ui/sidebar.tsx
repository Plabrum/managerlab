...
// Sidebar component: Adapts rendering based on mobile/desktop context
function Sidebar({
  side = 'left',
  variant = 'sidebar',
  ...
  // Desktop: Expand on hover when collapsed
  const effectiveState =
    state === 'collapsed' && isHovered ? 'expanded' : state;

  // Desktop: Static sidebar (never collapses)
  if (collapsible === 'none') {
    return (
      <div
        data-slot="sidebar"
  ...
  // Desktop: Collapsible sidebar with hover-to-expand
  return (
    <div

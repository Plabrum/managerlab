...
Revision ID: ede48058260c
Revises: 235c82a83956
Create Date: 2025-11-18 20:11:49.002135
...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        "fk_roster_profile_photo", "roster", "media", ["profile_photo_id"], ["id"], ondelete="SET NULL", use_alter=True
    )
...
def downgrade() -> None:
    ...
    op.drop_constraint("fk_roster_profile_photo", "roster", type_="foreignkey")

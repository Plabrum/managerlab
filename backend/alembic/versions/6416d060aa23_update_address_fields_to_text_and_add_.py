...
down_revision: str | Sequence[str] | None = "96e6568cba43"
...
def upgrade() -> None:
    ...
    op.alter_column("addresses", "state", existing_type=sa.VARCHAR(length=50), type_=sa.Text(), existing_nullable=True)
    op.alter_column("addresses", "zip", existing_type=sa.VARCHAR(length=20), type_=sa.Text(), existing_nullable=True)
    op.alter_column(
        "addresses", "country", existing_type=sa.VARCHAR(length=2), type_=sa.Text(), existing_nullable=False
    )
...
def downgrade() -> None:
    ...
    op.alter_column(
        "addresses", "country", existing_type=sa.Text(), type_=sa.VARCHAR(length=2), existing_nullable=False
    )
    op.alter_column("addresses", "zip", existing_type=sa.Text(), type_=sa.VARCHAR(length=20), existing_nullable=True)
    op.alter_column("addresses", "state", existing_type=sa.Text(), type_=sa.VARCHAR(length=50), existing_nullable=True)

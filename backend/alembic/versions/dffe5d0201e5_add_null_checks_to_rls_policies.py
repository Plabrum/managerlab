...
def upgrade() -> None:
    ...
    # Conditionally drop columns if they exist (they may not exist in fresh databases)
    op.drop_column("email_messages", "error_message", if_exists=True)
    op.drop_column("inbound_emails", "error_message", if_exists=True)
